            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" 230>
              ...
              <TR vAlign=top>
                <TD>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="99%" border=0>
                   <tr>
					<td><li><a href=addnotice.jsp target='frmright'>增加公告</a></li></td>
					</tr>
					<tr>
					<td><li><a href=morenotice.jsp target='frmright'>所有公告</a></li></td>
					</tr>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                  <tr>
					<td><li><a href=date_agent.jsp target='frmright'>我的日程安排</a></li></td>
					</tr>
					<tr>
					<td><li><a href=add_agent.jsp target='frmright'>增加日程安排</a></li></td>
					</tr>
					</TABLE>
					<!-- -->
					</DIV>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="99%" border=0>
                    <tr>
					<td><li><a href=getLetter.jsp target='frmright'>查看我的短信</a></li></td>
					</tr>
					<tr>
					<td><li><a href=sendletter.jsp target='frmright'>发送短信</a></li></td>
					</tr>
					<tr>
					<td><li><a href=Letter_histry.jsp target='frmright'>短信历史记录</a></li></td>
					</tr>
					</TABLE></DIV></TD></TR></TBODY></TABLE>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="99%" border=0>
                    <tr>
					<td><li><a href=Book_Index.jsp target='frmright'>查看我的通讯录</a></li></td>
					</tr>
					</TABLE></DIV></TD></TR></TBODY></TABLE>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="99%" border=0>
                    <tr>
					<td><li><a href=edit_manage.jsp target='frmright'>设置个人信息</a></li></td>
					</tr>
					<tr>
					<td><li><a href=show_manage.jsp target='frmright'>显示个人信息</a></li></td>
					</tr>
					</TABLE></DIV></TD></TR></TBODY></TABLE>
