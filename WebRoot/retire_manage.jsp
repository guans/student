...
<title>学生休学</title>
<tr><td height="22" valign="top" class="word_orange">当前位置：<a href="stu_file.jsp">学籍管理</a> &gt;&gt;&gt;学生休学</td></tr>
<hr width="100%" size="4">
		...
		<form id="test" method="post" name="查询" action="StudentThran">
			...
			<p align="center">
				...
				<input
					...
					type=submit style="width:70px;height:30px"  value=休学 name=action2>
				<input type="Hidden" name="action2" value='retire'>
				</td>
				</tr>
				...
				<tbody>
					...
					<tr>
						<td align="right" colspan="10" height="22">
							...
							选择/反选
							<input
								onClick="{if(confirm('确认要该同学休学？！\n\n确定要执行此项操作吗？')){return true;}return false;}"
								type=submit value=休学 name=action2>
