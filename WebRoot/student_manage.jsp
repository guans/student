...
<TR>
  <TD align=middle id=frmTitle vAlign=top name="fmTitle" class="main_left">
	...
	<IFRAME frameBorder=0 id=frmleft name=frmleft src="stu_m_left.jsp" class="left_iframe" allowTransparency="true"></IFRAME>
  ...
  <TD bgcolor="#337ABB" width="100%" vAlign=top>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#C4D8ED">
      ...
      align="center" name="thename">admin</span>
      <script language=javascript>
  showtime();
</script>
		<a href="student_manage.jsp" title="学籍管理"> 学籍管理 </a><a href="grade_manage">成绩管理 </a><a href="#"> 家长短信箱</a><a href="#"> 考勤</a></td>
		<td background="images/bg2.gif" style="text-align:right; color: #135294; "><a href="MyOA.jsp" target='_top'>首页</a> | <a href="useredit.jsp"  target='frmright'>修改个人资料</a> | <a onClick="window.parent.location.href='default.jsp'" href='#'>退出</a> </td>
	...
	<IFRAME frameBorder=0 id=frmright name=frmright scrolling=yes src="stu_file.jsp" class="main_iframe"></IFRAME>
