...
<TR>
  ...
  showtime();
		...
		<!--<a href="student_manage.jsp" title="学籍管理"> 学籍管理 </a><a href="Exam_set.jsp">成绩管理 </a><a href="Exam_set.jsp"> 家长短信箱</a><a href="#"> 考勤</a></td>
		--><td background="images/bg2.gif" style="text-align:right; color: #135294; "><a href="MyOA.jsp" target='_top'>首页</a> | <a href="edit_manage.jsp"  target='frmright'>修改个人资料</a> | <a onClick="window.parent.location.href='index.jsp'" href='#'>退出</a> </td>
