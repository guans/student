...
<title>学生退学</title>
<tr><td height="22" valign="top" class="word_orange">当前位置：<a href="stu_file.jsp">学籍管理</a> &gt;&gt;&gt;学生转学</td></tr>
<hr width="100%" size="4">
 <input type="button" value="返回" style="width:70px;height:30px"  onclick="javascript:history.go(-1);"> 
		...
		<form id="test" method="post" name="查询" action="StudentThran">
			...
			<p align="center">
				...
				<select name="combobox1" size="1" id="combobox1"
					onclick="setCookie('combobox1',this.selectedIndex)">
					<%
						String ids = "";
						try {
			...
			<p align="center">
				<label>
					<input name="search" type="submit" value="查询" style="width:70px;height:30px"
						onclick="javascript:submitForm('searchServlet')">
				</label>
				</label>
				<input
					onClick="{if(confirm('确认要该同学退学？！\n\n确定要执行此项操作吗？')){return true;}return false;}"
					type=submit value=退学 style="width:70px;height:30px"  name=action2>
			...
			<div style="width: 800px;">
				<div class="mini-toolbar" style="border-bottom: 0; padding: 0px;">
					<table style="width: 100%;">
						<tr>
							<td width="42%">
								<input name="thran_reason" type="text" size="20">
								转校原因
							</td>

							<td width="58%">
								<input name="thran_target" type="text" size="20">
								转校去向
							</td>
						</tr>
					</table>
				...
				<tbody>
					...
					<tr>
						<td align="right" colspan="10" height="22">
							...
							<input
								onClick="{if(confirm('确认要该同学退学？！\n\n确定要执行此项操作吗？')){return true;}return false;}"
								type=submit value=退学 name=action2>
							<input type="Hidden" name="action2" value='EXIT'>
						</td>
					</tr>
			</table>
	</body>
