...
<TR>
  <TD align=middle id=frmTitle vAlign=top name="fmTitle" class="main_left">
	...
	<IFRAME frameBorder=0 id=frmleft name=frmleft src="teacher_left.jsp" class="left_iframe" allowTransparency="true"></IFRAME>
  ...
  showtime();
		...
		<td background="images/bg2.gif" style="text-align:right; color: #135294; "><a href="teacher.jsp" target='_top'>首页</a>  | <a onClick="window.parent.location.href='default.jsp'" href='#'>退出</a> </td>
	...
	<IFRAME frameBorder=0 id=frmright name=frmright scrolling=yes src="teacher_index.jsp" class="main_iframe"></IFRAME>
