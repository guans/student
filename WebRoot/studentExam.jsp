...
<script type="text/javascript" src="lhgdialog.js"></script>
  ...
  <table width="102%" height="74" border="0" align=center cellpadding="3" cellspacing="1" bgcolor="#3399FF">
			  <tr>
			    <td  height=32 class="td_title" colspan="12" align="center">考试一览表<font color="#000000" size="4" face="Courier New, Courier, monospace">&nbsp;</font></td>
		      </tr>
		      <tr>
			  <tr>
			    <td width="10%" align="center">考试科目</td>
			    <td width="15%" align="center">考试时间</td>
			    <td width="10%" align="center">考场号</td>
			    <td width="10%" align="center">座位号</td>
...
<%try 
    { 
		  ...
		  String exam_sub="";String exam_data="";String exam_room="";
		  String exam_seat="";String exam_type="";
		 ...
		 exam_seat=rs.getString("SE_SEAT");
		  ...
		  %>
		  		<tr>
            	 <td width="10%" align="center"><li><%=exam_sub%> &nbsp;</li>  </td>
			    <td width="15%" align="center"><%=exam_data%> &nbsp;</td>
			    <td width="10%" align="center"><%=exam_room%> &nbsp;</td>
			    <td width="10%" align="center"><%=exam_seat%> &nbsp;</td>
			    <td width="10%" align="center"><%=exam_type%> &nbsp;</td>
			  </tr>
<%
        }
        rs.close();
  ...
  <p align="center"><font face="arial, helvetica" size="-2"><a href="aboutus.jsp">关于我们</p>
  </body>
