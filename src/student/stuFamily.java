...
public class stuFamily extends HttpServlet { // 用于新建，删除，更新学生家庭信息
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if (!type.equals("")) {
			...
			if (type.equals("searchServlet")) {
				...
				// 调用修改学生方法
				getServletContext().getRequestDispatcher("/edit_student.jsp?stud_id="+stu_id)
						.forward(req, res);
				...
				getServletContext().getRequestDispatcher("/imp_student.jsp")
						.forward(req, res);
